...
def main():
    ...
    process_data(cur, conn, filepath='/Users/junzhang/UdacityDE/1 - Data_Modeling_with_Postgres/data/song_data', func=process_song_file)
    process_data(cur, conn, filepath='/Users/junzhang/UdacityDE/1 - Data_Modeling_with_Postgres/data/log_data', func=process_log_file)
